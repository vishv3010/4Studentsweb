        ...
        >
          ...
          <div className="flex gap-1.5">
            {c.tags.map((tag) => (
              <span
                key={tag}
                className={`hero-tag text-[9px] ${c.tagBg} text-text-secondary px-2 py-0.5 rounded-md font-medium`}
              >
                {tag}
              </span>
            ))}
                ...
                >
                  <div className="hero-card-inner bg-white/95 backdrop-blur-md rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.1)] border border-border/40 p-3 w-[155px]">
                    ...
                    <div className="flex gap-1">
                      <span className="hero-tag text-[9px] bg-accent-lavender/60 text-text-secondary px-1.5 py-0.5 rounded font-medium">Hackathon</span>
                      <span className="hero-tag text-[9px] bg-accent-lavender/60 text-text-secondary px-1.5 py-0.5 rounded font-medium">Startup</span>
                    </div>
                  </div>
                </motion.div>
              </motion.div>
              ...
              >
                ...
                >
                  <div className="hero-card-inner bg-accent-yellow rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.08)] p-3 w-[150px]">
                    ...
                    <div className="flex gap-1">
                      <span className="hero-tag text-[9px] bg-white/60 text-text-secondary px-1.5 py-0.5 rounded font-semibold">Cricket</span>
                      <span className="hero-tag text-[9px] bg-white/60 text-text-secondary px-1.5 py-0.5 rounded font-semibold">Football</span>
                    </div>
                  </div>
                </motion.div>
              </motion.div>
              ...
              >
                ...
                >
                  <div className="hero-card-inner bg-accent-green rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.08)] p-3 w-[140px]">
                    ...
                    <div className="hero-tag mt-1 bg-white/60 rounded-md px-2 py-0.5 inline-block">
